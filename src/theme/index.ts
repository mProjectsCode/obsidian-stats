...
import {
    THEME_LIST_PATH, THEME_DATA_PATH, OBSIDIAN_RELEASES_FULL_PATH, THEME_TEMPLATE_FILE_PATH,
    THEME_TEMPLATE_REPLACEMENT_STRING, THEME_TEMPLATE_REPLACEMENT_STRING_JSON, THEME_TEMPLATE_OUTPUT_PATH,
} from "../constants.ts";
